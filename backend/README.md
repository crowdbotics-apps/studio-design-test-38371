...
## Project Structure
    ...
    ├── studio_design_test_38371  # Django project configurations
...
1. Clone this repo and `cd studio_design_test_38371`
...
2. Clone this repo and `cd studio_design_test_38371`

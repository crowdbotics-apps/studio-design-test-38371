"""
Django settings for studio_design_test_38371 project.
...
ROOT_URLCONF = 'studio_design_test_38371.urls'
...
WSGI_APPLICATION = 'studio_design_test_38371.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studio_design_test_38371 API",
    "DESCRIPTION": "API documentation for studio_design_test_38371 App",
    "VERSION": "v1",
}
